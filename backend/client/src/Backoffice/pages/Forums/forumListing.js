...
export default class forumList extends Component {
  ...
  componentDidMount() {
    axios.get(process.env.REACT_APP_URI_SERVER + '/forums/')
      .then(response => {
  ...
  deleteForum(id) {
    ...
    axios.delete(process.env.REACT_APP_URI_SERVER + '/forums/' + id
    )
  ...
  showComment(id) {
    axios.get(process.env.REACT_APP_URI_SERVER + '/forums/com/' + id)
  ...
  searchHandel = (event) => {
    ...
    axios.get(process.env.REACT_APP_URI_SERVER + '/forums/search/' + key)
      .then(response => {
        this.setState({ forums: response.data })
      })
      .catch((error) => {
