...
export default class ListDeadline extends Component {
    ...
    createAndDownloadPdf = () => {
        axios
            .post(process.env.REACT_APP_URI_SERVER + "/compaigns/addPDF", this.state)
            // .then(() => axios.get(process.env.REACT_APP_URI_SERVER+'/compaigns/pdf', { responseType: 'blob' }))
            .then((res) => {
    ...
    componentDidMount() {
        axios
            .get(process.env.REACT_APP_URI_SERVER + "/compaigns/dedlaine")
            .then((response) => {
    ...
    deleteCompaign(id) {
        axios.delete(process.env.REACT_APP_URI_SERVER + "/compaigns/" + id).then((response) => {
    ...
    searchHandel = (event) => {
        ...
        axios
            .get(process.env.REACT_APP_URI_SERVER + "/compaigns/search/" + key)
            .then((response) => {
                this.setState({ compaigns: response.data });
            })
            .catch((error) => {
