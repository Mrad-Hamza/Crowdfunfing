            ...
            <div style={{ backgroundColor: "#ffffff" }}>
                ...
                >
                    ...
                    <div style={{ bottom: 0, float: "center", width: "100%", paddingTop: "30px", textAlign: "center" }}>
                        <Link to={"/payment/" + props.compaign._id}>
                            <Button
...
export default class ProjectCard extends Component {
    constructor(props) {
        ...
        this.state = { compaigns: [], paymentDialog: false };
    }

    componentDidMount() {
        axios
            .get(process.env.REACT_APP_URI_SERVER + "/compaigns/front")
            .then((response) => {
    ...
    DialogPayment() {
        return (
            <Dialog visible={this.props.paymentDialog} style={{ width: "450px" }} header="Confirm" modal>
