...
import { deleteEventAction, setCommentsEvent } from "../../../Backoffice/features/actions/eventActions";

import { RemoveSelectedEvent, selectedEvent } from "../../../Backoffice/features/actions/eventActions";
import CommentSection from "../../../Backoffice/pages/events/commentSection";
import { height } from "@material-ui/system";

const EventDetailFront = ({ history }) => {
    ...
    return (
        <div className="ui" style={{ marginLeft: "10em" }}>
            <TabView>
                <TabPanel header="About">
                    <Card title={nameEvent} subTitle={eventType} style={{ width: "115em", height: "40em" }}>
                        <div>
...
export default EventDetailFront;
