        ...
        <div className="container-fluid m-5 text-left">
            ...
            >
                {data.popular_projects.map((item, index) => {
                    return (
                        <Card key={index} className="m-2 border" style={{ width: "280px", height: "290px", padding: "10px" }}>
                                ...
                                <div style={{ height: "100px" }} className="card-body">
                                    <div>
                                        ...
                                        <span style={{ float: "right" }}>
                                            <HeartOutlined style={{ fontSize: "20px", color: "lightgrey" }} />
                                        </span>
                                    </div>
                            ...
                            <br />
                            {/* categories */}
                            <div className=" text-muted p-1" style={{ position: "relative", top: "20px" }}>
                                ...
                                <div style={{ padding: "1px 0px 0px 20px" }}>
                                    <div style={{ float: "left" }}>
                                        <h4>
                                            {item.price}
                                            <span style={{ padding: "1px 6px 0px 2px", fontSize: "13px" }}>{item.currency}</span>
                                        </h4>
                                        {/* percentag */}
                                    </div>
                                ...
                                <div style={{ padding: "4px 6px 0px 20px", clear: "both" }}>
                                    ...
                                    <span style={{ fontSize: "12px", float: "right" }}>InDEMAND</span>
                                </div>
                            </div>
                        </Card>
                    );
