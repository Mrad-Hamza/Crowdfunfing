...
class ForumComment extends Component {
    ...
    deleteComment(id) {
        axios.delete("http://localhost:5000/comment/" + id).then((response) => {
    ...
    onSubmit(e) {
        ...
        axios.post("http://localhost:5000/comment/add/", comment).then((res) => console.log(res.data));
    }
    sendMail(mail) {
        axios
            .post("http://localhost:5000/comment/badmsg/" + mail)
