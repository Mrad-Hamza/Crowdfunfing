...
export function LoginForm(props) {
    ...
    const detect = async () => {
        ...
        // const result = [new Float32Array(detections.descriptor)];
            ...
            <BoxContainer>
                ...
                <Dialog visible={imgDialog} style={{ width: "550px" }} header="Facial Recognition" modal className="p-fluid" footer={ImgDialogFooter} onHide={hideImgDialog}>
                    <div className="main">
                        ...
                        {/* <Input type="file" accept="image/png, image/jpeg, image/jpg" onChange={handleFirstImageUpload} /> */}
                        <div className="img-container" style={{ position: "relative" }}>
                            <img id="first-img" src={firstImg} style={{ height: 300, width: 300 }} />
                            <canvas id="canvas1" width="300px" height="300px"></canvas>
                        </div>
                        {/* <input type="file" accept="image/png, image/jpeg, image/jpg" onChange={handleSecondImageUpload} /> */}
                        <div className="img-container" style={{ position: "relative" }}>
                            {/* <img id="second-img" src={secondImg} style={{ height: 300, width: 300 }} />
                    ...
                    {/* <div className="col-12">
                        ...
                        <div className="card">
                            <img src={"https://raw.githubusercontent.com/selmagassab/CrowdFundingProject/43e714ba81cd407278aa8026fde1653226d60d5e/src/assets/layout/images/aa.jpg"} alt="" width={400} height={videoHeight} />
